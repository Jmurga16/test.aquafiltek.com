...
$resultado = mysqli_query($enlace, "SELECT dc.nombre_completo AS nombre, dc.codigo AS codigo FROM `DatosClientes` AS dc WHERE estado='Por gestionar'");

echo '<h4 class="text-center text-warning">Existen <span class="text-danger">' . mysqli_num_rows($resultado) . '</span> clientes sin gestionar</h4>';
?>
