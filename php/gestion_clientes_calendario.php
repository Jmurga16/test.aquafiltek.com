...
<!--Nav bar --------->
    ...
    <div class="container hide" id="ContainerGL" style="margin-top: 20px;">
        ...
        $num_data = mysqli_num_rows(mysqli_query($enlace,$data));
        ?>
        <div align="right">
            <input type="button" style="width:280px" id='botonNuevos' class="btn btn-info" onclick="mostrar_pendientes()" value="Clientes pendientes de código (<?php echo "$num_data";    ?>)"/>
    </div>
...
<!-------------------------------sohaib----------------------------------->
        ...
        <div align="center" id='desatendido' style='width:20%;display:none;margin-left:80%'>
        <h5 style='background-color:#1A394A; color:white; padding:4px'>Cliente desatendido</h5>
        </div>
...
-->
 ...
 <div id="modal_inactivar_div">
    ...
    <!-- MODAL EDITAR ID NUEVOS -->
    <div class="modal fade" id="ModalNuevos" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Editar código de clientes nuevos </h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <input type='button' id='guardarIdAct' class='btn btn-success' value='Guardar'/>
                </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade minimizable" id="gestionModal_%id%" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div id="comentariosU_%id%" class="col-md-10" style="margin: 0px auto; background-color: white; padding:  10px 10px 10px 10px"></div>
                ...
                <div class="modal-footer" style="display:block">
                    ...
                    <button class="btn btn-danger btn-sm btn_competU" id="btn_competU_%id%">Competencia</button></td>
