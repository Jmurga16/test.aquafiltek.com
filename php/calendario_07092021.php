        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="horaAcepto">
                        <input type="number" id="horaAC" class="hora" min="6" max="18" maxlength="2" onblur="validaHoraMinuto('','minutoAC')">
                        <label> : </label>
                        <input type="number" id="minutoAC" class="hora" min="0" max="59" maxlength="2" onblur="validaHoraMinuto('','comment')">
