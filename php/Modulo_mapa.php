    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto  navbar-nav navbar-center">
                ...
                <li class="nav-item" id="PgenerarR">
                    <a class="nav-link" href="Modulo_Usuario.php" target="_blank" >Gestión usuario</a>
                </li>
                <!--tech plus -->
...
<!--Nav bar --------->
    ...
    <div class="container " id="ContainerGL" style="margin-top: 20px;">
              ...
              <tfoot>
                  <tr>
                      <td colspan="7">
                        ...
                        <button class="btn btn-success btn-md " id="btn_otro">Otro</button></td>
                  </tr>
              </tfoot>
          </table>
      </div>
...
<input type="hidden" id="minutoPV_vv">
        ...
        <div class="modal-dialog modal-lg" id="modal-xlg_%id%" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br><br>
                    <textarea id="comentariosUG_%id%" resizable="false"></textarea>
                    <textarea id="comentariosU_%id%" resizable="false"></textarea>
                </div>
                <div class="modal-footer" style="display:block">
                    <button class="btn btn-success btn-md btn_aceptoU" id="btn_aceptoU_%id%">Aceptó</button>
    ...
    <div class="container text-center" id="containerGR" style="display: none">
        ...
        <script type="text/javascript" src="../js/gestion_mapa.js?v=<?php echo time()?>"></script>
        <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDihvdrN7V4We7rPewTUpyr4DzF-JEunkA&callback=initMap">
    </script>
