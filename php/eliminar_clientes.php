...
<body>
    ...
    <div class="container lote">
		...
		<br><br>
    <button  class="btn btn-success" id="delete_clients">Eliminar clientes</button>
   <!-- Modal confirmacion -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-center text-dark"><span class="text-success" id="cant_cl"></span> Clientes van a ser eliminados</h4>
...
//         var table = $('#table_lote').DataTable({
