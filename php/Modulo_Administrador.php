...
<div class="container" >
  ...
  <div class="tab-content">
    ...
    <div align="right">
        ...
        ?>
        <input type='button' style="width:200px" class='btn btn-primary' onclick="mostrar_asign()" value='Repartir clientes (<?php echo "$num_all"; ?>)' <?php if($num_all == 0){ echo "disabled";}   ?>/>
    </div>
    <br/>
  ...
  <tbody id="llenar_iediciones">
    ...
    <div class="container text-center" id="containerEscalasUsuario" style="display:none">
        ...
        <div class="btn-group">
            <!--<label>Selecciona operador</label><br>-->
           ...
           <!--<button id="ecr" type="button btn_xxl" class="btn btn-primary">Ver  clientes repetidos</button>
            -->
        </div>
        <hr/>
        <div id="div_escalas" style="display:none">
            ...
            <br/>
            <center><h4 style="padding:4px; background-color: white; width:150px; margin-right:20px"><strong>Filtro actual:      
                <?php 
        ...
        <br/>
    <input type='button' class='btn btn-primary' style='width:150px' value='Guardar' onclick="actualizar_filtro()"/></center>
    <br/>
                </div>
</div>
    ...
    <div class="container text-center" id="containerTira" style="display:none">
        ...
        <div class="form-group">
                    ...
                    <div id="tiempo_tira" class="form-group" style="display:<?php echo isset($data_tira["permanente"]) && $data_tira["permanente"] == 0?"block":"none" ?>">
                       ...
                       <input id="txt_minutos_tira" type="number" class="form-control"  min="0" max="9999" 
                       value="<?php echo isset($data_tira["minutos"])?$data_tira["minutos"]:"0"; ?>"/>
