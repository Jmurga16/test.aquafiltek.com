...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <?php
        //confirmo si el operador esta en descanso MG
        require('connect.php');
        $sql = "SELECT descanso FROM DatosIngreso WHERE id = '$id_sesion'";
        $descanso = mysqli_query($enlace, $sql);
        $desc = mysqli_fetch_array($descanso);
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto  navbar-nav navbar-center">
                ...
                <li class="nav-item" id="PgenerarR">
                    <a class="nav-link" href="gestion_clientes_calendario.php" target="_blank">Gestión por calendario</a>
                </li>
                <li class="nav-item" id="PgenerarR">
    ...
    <div class="container hide" id="ContainerGL" style="margin-top: 20px;">
        ...
        <div class="container search-box" style="margin-bottom:10px">
            <div class="row" style="width:120%; margin: 0px auto">
                ...
                <tfoot style="width:110%">
                    <tr>
                        <td colspan="7">
                            ...
                            <button class="btn btn-danger btn-sm" id="btn_compet">Competencia</button>
                        </td>
                    </tr>
      ...
      <input type="text" class="form-control" id="input_BCCC" placeholde="Buscar cliente por telefono">
        ...
        <div id="div_contenttable" style="width:100%;">
            ...
            <div class="row">
                ...
                echo "<div id='sugerencia' style='margin-left:15px'></div>";
        ...
        <br />
        <div class="row">
            <div id="comentarios" class="col-md-10" style="margin: 0px auto;"></div>
        </div>
        ...
        <div class="modal-dialog modal-lg" id="modal-xlg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="fr contenedorC">
                        <h5>Comentarios historicos aquí</h5>
                    </div>
                    <br><br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="horaAceptoCom">
                        <input type="number" id="horaACOM" class="hora" min="6" max="18" maxlength="2">
                        <label> : </label>
                        <input type="number" id="minutoACOM" class="hora" min="0" max="59" maxlength="2">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <?php $fecha_act = date("d-m-Y");
                            $hora_act = date("h:i");
                            echo "$fecha_act <br/> $hora_act"; ?>
                        </div>
                        <div class="col-md-9">
    ...
    <div class="modal fade" id="ModalACPG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Competencia</h3>
                ...
                <div class="modal-body">
                    <label for="idclc">Nombre del cliente</label>
                    <input type="text" class="form-control" id="idclcPG" disabled="true">


                    <label>Fecha ejecución del servicio por la competencia</label>

                    <input id="fechaAceptoComPG" class="form-control" type="date" width="276" onkeydown="return false">
                    <br />
                    <label>Hora ejecución del servicio por la competencia</label>
                    <div id="horaAceptoComPG">
                        <input type="number" id="horaACOMPG" class="hora" min="6" max="18" maxlength="2">
                        <label> : </label>
                        <input type="number" id="minutoACOMPG" class="hora" min="0" max="59" maxlength="2">
                        <label class="text-danger hide alertaHNL" id="alertaHNLC">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="commentCOMPG">
                        </div>
                    </div>
                    <p class="text-danger text-center hide" id="mensaje_error_aceptoPGCOM"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GuardarACOMPG">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- aceptopg -->
    <div class="modal fade" id="ModalAPG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Gestión aceptada</h3>
                ...
                <div class="modal-body">
                    <label for="idcl">Nombre del cliente</label>
                    <input type="text" class="form-control" id="idclpg" disabled="true">


                    <label for="fechaAcepto">Fecha ejecución del servicio</label>

                    <input id="fechaAceptopg" class="form-control" type="date" width="276" onkeydown="return false">

                    <label for="horaAcepto">Hora ejecución del servicio</label>
                    <div id="horaAceptopg">
                        <input type="number" id="horaACpg" class="hora" min="6" max="18" maxlength="2" onkeyup="validaFormatoHora(this.value,true,'');" onblur="validaHoraMinuto('','minutoAC')">
                        <label> : </label>
                        <input type="number" id="minutoACpg" class="hora" min="0" max="59" maxlength="2" onkeyup="validaFormatoHora(this.value,false,'');" onblur="validaHoraMinuto('','comment')">
                        <label class="text-danger hide alertaHNL" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                    ...
                    <div id="horas_ocupadaspg" class="text-danger">

                    </div>
                    <label for="comment">Comentarios adicionales</label>


                    <input type="text" class="form-control" id="commentpg">
                    <p class="text-danger text-center hide" id="mensaje_error_aceptopg"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GuardarAPG">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- rechazo -->
    <div class="modal fade" id="ModalREPG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Gestión rechazada</h3>
                ...
                <div class="modal-body">
                    <form>
                        <label for="idclRPG">Nombre del cliente</label>
                        <input type="text" class="form-control" id="idclRPG" disabled="true">
                        <label for="horaRechazoPG">Hora rechazo</label>
                        <input type="text" class="form-control" id="horaRechazoPG" disabled="true">
                        <label for="fechaRechazoPG">Fecha rechazo</label>
                        <input id="fechaRechazoPG" class="fechapicker" width="276" disabled="true" />
                        <label for="comment">Comentarios adicionales</label>
                        <input type="text" class="form-control" id="commentREPG">
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GuardarRPG">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Reprogramar PG-->
    <div class="modal fade" id="ModalRPG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary" id="lb_reprogramarPG">Reprogramar llamada</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <span id="tipoModal" class="hide"></span>
                    <label for="idCliente">Nombre Cliente</label>
                    <input type="text" class="form-control" id="idClientePG" disabled="true">
                    <label for="fechaLlamada">Fecha llamada</label>
                    <input id="fechaLlamadaPG" min="<?php echo date('Y-m-d') ?>" class="form-control" type="date" width="276">
                    <label for="horaLlamadaPG">Hora llamada</label>
                    <div id="horaLlamadaPG">

                        <input type="hidden" id="horaPG" name="hora" value="">
                        <input type="hidden" id="minutoPG" name="minuto" value="">
                        <input type="hidden" id="selec_respPG" name="selec_resp" value="">

                        <input type="number" id="hora_mosPG" class="hora" min="0" max="23" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minuto'), 2)" disabled>
                        <label> : </label>
                        <input type="number" id="minuto_mosPG" class="hora" min="0" max="59" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('commentR'), 2)" disabled>


                        <label class="text-danger hide" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                    <label for="commentRRPG">Comentarios adicionales</label>
                    <input type="text" class="form-control" name="commentRPG" id="commentRPG">
                    <p class="text-danger hide" id="error_horaPG"></p>

                    <table style="font-size:13px" class="table-bordered table-striped" id="tabla_horaPG">

                    </table>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="ReprogramarLLPG">Reprogramar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Averiado -->
    <div class="modal fade" id="ModalAvPG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary" id="lb_reprogramarPG">Averiado</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <span id="tipoModal" class="hide"></span>
                    <label for="idClienteAv">Nombre Cliente</label>
                    <input type="text" class="form-control" id="idClienteAvPG" disabled="true">
                    <br />
                    <br />
                    <label for="commentR">Comentarios adicionales</label>
                    <input type="text" class="form-control" name="commentAvPG" id="commentAv">
                    <p class="text-danger hide" id="error_horaPG"></p>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="AveriadoGPG">Inactivar por averiado</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="postv">
            ...
            <div id="reprogramarPV">
                ...
                <div id="horaLlamadaPV">
                    ...
                    <input type="text" id="horaPV" class="hora" min="0" max="23" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minutoPV'), 2)">
                    <label> : </label>
                    <input type="text" id="minutoPV" class="hora" min="0" max="59" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('commentR'), 2)">
                    <label class="text-danger hide" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                </div>
    ...
    <div class="modal fade" id="ModalInspeccionpg" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Inspección </h3>
                ...
                <div class="modal-body">
                    <label for="idclInspeccion">Nombre del cliente</label>
                    <input type="text" class="form-control" id="idclInspeccionpg" disabled="true">


                    <label for="fechaAceptoInspeccionpg">Fecha ejecución del servicio</label>

                    <input id="fechaAceptoInspeccionpg" class="form-control" type="date" width="276">

                    <label for="horaAceptoInspeccion">Hora ejecución del servicio</label>
                    <div id="horaAceptoInspeccionpg">
                        <input type="number" id="horaACInspeccionpg" class="hora" min="6" max="18" maxlength="2" onkeyup="validaFormatoHora(this.value,true,'Inspeccion');" onblur="validaHoraMinuto('Inspeccion','minutoAC')">
                        <label> : </label>
                        <input type="number" id="minutoACInspeccionpg" class="hora" min="0" max="59" maxlength="2" onkeyup="validaFormatoHora(this.value,false,'Inspeccion');" onblur="validaHoraMinuto('Inspeccion','comment')">
                        <label class="text-danger hide alertaHNL" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                    ...
                    <div id="horas_ocupadasInspeccionpg" class="text-danger">
                    </div>
                    <label for="commentInspeccion">Comentarios adicionales</label>
                    <input type="text" class="form-control" id="commentInspeccionpg">
                    <p class="text-danger text-center hide" id="mensaje_error_aceptoInspeccionpg"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GuardarInspeccionPG">Guardar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="horaAceptoCobros">
                        <input type="number" id="horaACCobros" class="hora" min="6" max="18" maxlength="2" onkeyup="validaFormatoHora(this.value,true,'Cobros');" onblur="validaHoraMinuto('Cobros','minutoAC')">
                        <label> : </label>
                        <input type="number" id="minutoACCobros" class="hora" min="0" max="59" maxlength="2" onkeyup="validaFormatoHora(this.value,false,'Cobros');" onblur="validaHoraMinuto('Cobros','comment')">
                        <label class="text-danger hide alertaHNL" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
    ...
    <!--modal importante-->
    <div class="modal fade" id="ModalImportantePG" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="text-center text-primary">Importante </h3>
                ...
                <div class="modal-body">
                    <label for="idclImportante">Nombre del cliente</label>
                    <input type="text" class="form-control" id="idclImportantePG" disabled="true">


                    <label for="fechaAceptoImportante">Fecha ejecución del servicio</label>

                    <input id="fechaAceptoImportantePG" class="form-control" type="date" width="276">

                    <label for="horaAceptoImportante">Hora ejecución del servicio</label>
                    <div id="horaAceptoImportantePG">
                        <input type="number" id="horaACImportantePG" class="hora" min="6" max="18" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minutoAC'), 2)">
                        <label> : </label>
                        <input type="number" id="minutoACImportantePG" class="hora" min="0" max="59" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('comment'), 2)">
                        <label class="text-danger hide alertaHNL" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>

                    <label for="comment">Horas Ocupadas</label>

                    <div id="horas_ocupadasImportantePG" class="text-danger">
                    </div>
                    <label for="commentImportantePG">Comentarios adicionales</label>
                    <input type="text" class="form-control" id="commentImportantePG">
                    <p class="text-danger text-center hide" id="mensaje_error_aceptoImportantePG"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GuardarImportantePG">Guardar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-lg" id="modal-xlg_%id%" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br>
                        <div class="row">
                            <div id="comentariosU_%id%" class="col-md-10" style="margin: 0px auto; background-color: white; padding:  10px 10px 10px 10px"></div>
                        </div>
                        <!-- <textarea id="comentariosU_%id%" resizable="false" class="col-md-12" style="height:120px"></textarea> -->
                    ...
                    <div class="modal-footer" style="display:block">
                        ...
                        <button class="btn btn-danger btn-sm btn_competU" id="btn_competU_%id%">Competencia</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- modal recordatori-->
    <div id="modal_inactivar_div">
        <div class="modal fade minimizable" id="modal_recor" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lg" id="gestion_rec" role="document">
                <div class="modal-content">
                    <div class="modal-header cursormover ">
                        <h5 class="modal-title text-center">Recordatorio de gestiones</h5>
    ...
    <div class="container text-center" id="containerGR" style="display: none">
        ...
        <div class="report">
            ...
            <div class="form-group">
                ...
                <input type="text" id="fechaAceptoR" name="daterange2" value="01/01/2018 - 01/15/2018" style="cursor: pointer; width: 25%; margin-left: 5%; text-align: center;" />
            </div>
    ...
    <script>
        ...
        if (!empty($_GET["c"])) {
            ...
            if (!empty($_GET["editar_cliente"])) {
                ...
                echo "document.getElementById('Gllamada').click();";
        }
        ?>
    </script>
    ...
    <div class="modal fade" id='pgmodal' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">

            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Clientes por gestionar</h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="button" class="btn btn-success" value="Gestionar seleccionados" onclick="gestionar_pg()">
                        </div>
                    </div>
                </div>
            </div>
