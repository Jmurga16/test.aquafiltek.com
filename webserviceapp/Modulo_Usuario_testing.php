...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="../libs/select2-4.0.3/dist/css/select2.min.css">
</head>
...
?>
        ...
        <br><br>
        <div class="input-group mb-2 mr-md-2 search-box" id="BC">
            <div class="input-group-prepend">
                <button class="btn btn-success" id="btn-buscar"><i class="fa fa-search"></i></button>
            </div>
            <input type="text" class="form-control" id="input_BC" placeholder="Buscar cliente por nombre">
        </div>
         <!--tech plus lhr -->
        ...
        <div style="float:right;display:none!important ; height:100px;overflow-y:scroll" id="results"></div>
          ...
          <!--tech plus lhr -->
        <div class="input-group mb-2 mr-md-2 search-box" id="BCC">
            <div class="input-group-prepend">
                <button class="btn btn-success" id="btn-buscar-c"><i class="fa fa-search"></i></button>
            </div>
      <input type="text" class="form-control" id="input_BCC" placeholder="Buscar cliente por ciudadela">
        ...
        <div style="float:right;" id="results"></div>
          tech plus lhr -->
        <div class="input-group mb-2 mr-md-2 search-box" id="BCCC">
            <div class="input-group-prepend">
    ...
    <div class="modal fade" id="Modal_buscar_cliente" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="GestionarC">Gestionar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="horaAcepto">
                        <input type="number" id="horaAC" class="hora" min="0" max="23" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minutoAC'), 2)">
                        <label> : </label>
                    ...
                    <input id="fechaAcepto" class="fechapicker" width="276" disabled="true" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input id="fechaLlamada" class="fechapicker" width="276" />
                    <label for="horaLlamada">Hora llamada</label>
                    <div id="horaLlamada">
                        <input type="number" id="hora" class="hora" min="0" max="23" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minuto'), 2)">
                        <label> : </label>
                        <input type="number" id="minuto" class="hora" min="0" max="59" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('commentR'), 2)">
                        <label class="text-danger hide" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select>
                                ...
                                <option value="asistente oficina">asistente oficina</option>
                        ...
                        <div class="form-group">
                            ...
                            <select>
                                <option value="Seleccionar opción">Seleccionar opción</option>
                                <option value="o_señor">señor</option>
                                <option value="o_señora">señora</option>
                                <option value="o_hijo/a">hijo/a</option>
                                <option value="o_asistente oficina">asistente oficina</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select>
                                <option value="Seleccionar opción">Seleccionar opción</option>
                                <option value="c_señor">señor</option>
                                <option value="c_señora">señora</option>
                                <option value="c_hijo/a">hijo/a</option>
                                <option value="c_asistente oficina">asistente oficina</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select>
                                <option value="Seleccionar opción">Seleccionar opción</option>
                                <option value="cc_señor">señor</option>
                                <option value="cc_señora">señora</option>
                                <option value="cc_hijo/a">hijo/a</option>
                                <option value="cc_asistente oficina">asistente oficina</option>
                            </select>
                        </div>
                        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div id="postv">
                ...
                <div id="reprogramarPV">
                    ...
                    <input id="fechaLlamadaPV" class="fechapicker" width="276" />
                    <label for="horaLlamadaPV">Hora llamada</label>
                    <div id="horaLlamadaPV">
                        <input type="number" id="horaPV" class="hora" min="0" max="23" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('minutoPV'), 2)">
                        <label> : </label>
                        <input type="number" id="minutoPV" class="hora" min="0" max="59" maxlength="2" onKeyPress="pasaSiguiente(this, document.getElementById('commentR'), 2)">
                        <label class="text-danger hide" id="alertaHNL">Hey, estas agendando fuera de horario laborable</label>
                    </div>
                </div>
                <br><br>
