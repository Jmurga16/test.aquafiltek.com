...
case 0:
	...
	if (mysqli_num_rows($result_gestion) == 0) {
		...
		if ($data_gestion['gestiones'] == 0) {
			echo "<a id=\"mostrar_estadistica\">
                <img src=\"../img/emoticonos/" . $image . "\"> <br><span style='background-color:#ffffff'>No tienes ninguna gestión el dia de hoy.</span>
            </a>" . $script;
		} else if ($data_gestion['gestiones'] == 1) {
			echo "<a id=\"mostrar_estadistica\">
                <img src=\"../img/emoticonos/" . $image . "\"> <br><span style='background-color:#ffffff'>Tienes " . $data_gestion['gestiones'] . " gestión el dia de hoy.</span>
            </a>
            " . $script;
		} else {
			echo "<a id=\"mostrar_estadistica\">
                <img src=\"../img/emoticonos/" . $image . "\"> <br><span style='background-color:#ffffff'>Tienes " . $data_gestion['gestiones'] . " gestiones el dia de hoy.</span>
            </a>
            " . $script;
		}
	}
