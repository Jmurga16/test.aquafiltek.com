...
join DatosIngreso as di on di.id=cg.id_operador where (STR_TO_DATE(ga.fecha_acepto, '%d/%m/%Y'))='".$_REQUEST["fecha"]."' and  (TIME_FORMAT(ga.hora_acepto, '%H:%i:%s')) BETWEEN '".$inicio."' and  '".$fin."'";
