...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <!-- Required meta tags -->
   <?php $numero= (rand(10,50));  ?> 
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Font-Awesome CC -->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="../css/style.css?id=<?php echo $numero; ?>">
    <link rel="stylesheet" type="text/css" href="../css/styleR.css?id=<?php echo $numero; ?>">
    <link rel="stylesheet" type="text/css" href="../css/styleU.css?id=<?php echo $numero; ?>">
...
<div id="snackbar"></div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" id="btn_panel" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto  navbar-nav navbar-center" style="font-size:25px">
                ...
                <li class="nav-item" id="cerrar_sesion">
...
<!--Nav bar --------->
    ...
    <div class="container hide" id="ContainerR" style="margin-top: 20px;">
        ...
        <div class="alert alert-danger" role="alert" id="tableDanger" class="hide">
            <h3 class="text-center">LLAMADAS URGENTES</h3>
        ...
        <div class="alert alert-warning hide" role="alert" id="tableWarning">
            <h3 class="text-center">LLAMADAS ESTA SEMANA</h3>
    ...
    <div class="container hide" id="ContainerGL" style="margin-top: 20px;">
        ...
        <button class="btn btn-primary btn-md btn-top" id="descansar" style="width:90%; font-size:25px">Descansar</button>
        <button class="btn btn-primary btn-md btn-top" id="almorzar" style="width:90%; font-size:25px">Hora Almuerzo</button>
        <?php if ($_SESSION['permisos'] == 1) {
	echo "<button class=\"btn btn-primary btn-md btn-top\" id=\"addCN\" style=\"width:90%; font-size:25px\">Agregar nuevo cliente</button>";
	echo "<button class=\"btn btn-primary btn-md btn-top\" id=\"modCA\" style=\"width:90%; font-size:25px\">Modificar cliente actual</button>";
}
?>
        <button class="btn btn-primary btn-md btn-top" id="rh" style="width:90%; font-size:25px">Resumen Historial</button>
        <button class="btn btn-primary btn-md btn-top" id="bPDF" style="width:90%; font-size:25px">Buscar PDF</button>
        <button class="btn btn-primary btn-md btn-top" id="bCL" style="width:90%; font-size:25px">Buscar cliente</button>
        <button class="btn btn-primary btn-md btn-top" id="btn_mantenimiento" style="width:90%; font-size:25px">Calendario mantenimiento</button>
        <br><br>
...
<div class="container search-box" style="margin-bottom:10px" >
  <div class="row">
    ...
    <button class="btn btn-success  btn-md btn-top" style="width:95%;margin-top: 0px;" id="GestionarC"><i class="fa fa-search"></i>Buscar</button>
    </div>
  </div>  
</div>
  ...
  <div class="row">
    ...
    <div class="col-sm-11" style="padding-left:0px;">
    <button class="btn btn-success  btn-md btn-top" style="width:95%;margin-top: 0px;"  id="btn-buscar-c"><i class="fa fa-search"></i>Buscar</button>
    </div>
  </div>  
</div>
...
<div class="container search-box" style="margin-bottom:10px">
  <div class="row">
    ...
    <div class="col-sm-11" style="padding-left:0px;">
    <button class="btn btn-success  btn-md btn-top" style="width:95%;margin-top: 0px;"  id="btn-buscar-cc"><i class="fa fa-search"></i></button>
    </div>
  </div>  
</div>
...
<!-------------------------------sohaib----------------------------------->
        ...
        <div class="accordion accordion-margin" id="clienteAnterior">
            <div class="card card-dark">
                <div class="card-header" id="headingOne">
                    <h5 class="mb-0">
        <button class="btn btn-link text-center text-link" style="font-size:25px" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Cliente anterior
                  <button style="float: right; margin-left: 20px; font-size:16px" class="btn btn-info btn-sm" id="gestionarAnterior">Gestionar cliente</button>
                <button style="float: right; font-size:16px" class="btn btn-primary btn-sm" id="historialAnterior">Ver historial gestion</button>
        </button>
      </h5>
                </div>
        ...
        <table class="table table-bordered table-lg "  style="background-color:#f8f9fa; color:#000000" id="tabla_clienteA">
          <!--  <thead>
                <tr>
                    <th scope="col">Nombre Cliente</th>
                    <th scope="col">Datos Factura</th>
        ...
        <button class="btn btn-success btn-md btn-top" id="btn_acepto" style="width:90%; font-size:25px">Aceptó</button>
        <button class="btn btn-success btn-md btn-top " id="btn_volver" style="width:90%; font-size:25px">Volver a llamar</button>
        <button class="btn btn-success btn-md btn-top" id="btn_rechazo" style="width:90%; font-size:25px">Rechazó</button>
        <button class="btn btn-success btn-md btn-top" id="btn_Nresponde" style="width:90%; font-size:25px">No responde</button>
        <button class="btn btn-success btn-md btn-top" id="btn_equivocado" style="width:90%; font-size:25px">Equivocado</button>
        <button class="btn btn-success btn-md btn-top" id="btn_averiado" style="width:90%; font-size:25px">Averiado</button>
        <button class="btn btn-success btn-md btn-top" id="btn_otro" style="width:90%; font-size:25px">Otro</button>
        <div id="estadistica_gestion" class="text-center">
        ...
        <div class="accordion accordion-margin" id="clienteNXT">
            <div class="card card-dark">
                <div class="card-header" id="headingTwo">
                    <h5 class="mb-0">
        <button class="btn btn-link text-center text-link" style="font-size:25px" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          Siguente cliente
                <button style="float: right; margin-left: 20px; font-size:16px" class="btn btn-info btn-sm" id="gestionarNext">Gestionar cliente</button>
                <button style="float: right; font-size:16px" class="btn btn-primary btn-sm" id="historialNext">Ver historial gestion</button>
        </button>
      </h5>
                </div>
        ...
        <div class="accordion accordion-margin" id="clienteNXT2">
            <div class="card card-dark">
                <div class="card-header" id="headingThree">
                    <h5 class="mb-0">
        <button class="btn btn-link text-center text-link" style="font-size:25px" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
          Siguente cliente
                <button style="float: right; margin-left: 20px; font-size:16px" class="btn btn-info btn-sm" id="gestionarNext2">Gestionar cliente</button>
                <button style="float: right; font-size:16px" class="btn btn-primary btn-sm" id="historialNext2">Ver historial gestion</button>
        </button>
      </h5>
                </div>
        ...
        <div class="modal-dialog modal-lg" id="modal-xlg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <br><button class="btn btn-sm btn-success" id="resume_h">Resumen Historial </button>
                </div>
                <div class="modal-body">
                   ...
                   <!-- <table class="table table-bordered table-sm table-dark" id="tabla_clienteU2">
                    ...
                    <button class="btn btn-success btn-md btn-top" style="width:90%" id="btn_aceptoU">Aceptó</button>
                    <button class="btn btn-success btn-md btn-top" style="width:90%" id="btn_volverU">Volver a llamar</button>
                    <button class="btn btn-success btn-md btn-top" style="width:90%" id="btn_rechazoU">Rechazó</button>
                    <button class="btn btn-success btn-md btn-top" style="width:90%" id="btn_NrespondeU">No responde</button>
                    <button class="btn btn-success btn-md btn-top"  style="width:90%" id="btn_equivocadoU">Equivocado</button>
                    <button class="btn btn-success btn-md btn-top" style="width:90%" id="btn_averiadoU">Averiado</button>
                    <button class="btn btn-success btn-md btn-top"  style="width:90%" id="btn_otroU">Otro</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input id="fechaAcepto" min="<?php echo date ('Y-m-d')?>"  class="form-control" type="date"  width="276"  onkeydown="return false">
...
<input type="hidden" id="minutoPV_vv">
    ...
    <div class="container text-center" id="containerGR" style="display: none">
        ...
        <script type="text/javascript" src="../js/usuario.js?id=<?php echo $numero; ?>"></script>
