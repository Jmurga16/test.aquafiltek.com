...
//  $(".loader").fadeIn("slow");
  ...
  $.post("../php/getAllClients_calendario_hoy.php", {
    ...
    data_ultimo_cliente = getUltimoCliente();
    ...
    console.log('hoy ult coords:'+ult_coords);
    ...
    $.post("../php/getAllClients_calendario.php", {
        ...
        coords: ult_coords
          ...
          if( !data.error ){
                ...
                console.log('cercanos:'+data.data.length);
                ...
                for (var i = 0; i < data.data.length; i++) {
                  var sc = data.data[i];
                  if(contador == -1){
                      console.log('asignar primer cliente cercano:');
                      contador = 0;
                  }
                  cadena += ($.trim(sc.codigo) + "|");
                  json_clientes.push(sc);
                  idx_cont++;
                }
    ...
    function getUltimoCliente(){
        ...
        for ( let i = hora ; i <= 23 ; i++){//18 26082021
             for( let j= 0; j < json_clientes_hoy.length ; j++ ){
                 ...
                 /*else{
                     if( i > hora ){
                         console.log('ya se tenía último cliente');
                         break;
                     } 
                     else{
                         console.log('no hay clientes a esta hora se toma el siguiente');
                        ultimo_cliente = json_clientes_hoy[j+1];
                        break;
                     }
                 }*/
             }
             ...
             /*obj = json_clientes_hoy.find( cli => cli.int_hora === i);
             let idx = json_clientes_hoy.findIndex( cli => cli.int_hora === i);
             ...
             if( obj === undefined ){
                 ...
                 ultimo_cliente = obj;
                 console.log('hora ocupada:'+i+' ult:'+ultimo_cliente.codigo+'-n:'+ultimo_cliente.nombre_completo);
