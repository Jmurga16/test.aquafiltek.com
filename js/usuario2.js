...
function gestionar_urgente(id_cliente) {
  ...
  $.when($.post("../php/obtenerDatosCliente.php", {
    ...
    //29012021 agregar id a clientes mostrados
    console.log(arr_clientes_mostrados);
    console.log(id_cliente);
    if(arr_clientes_mostrados.indexOf(id_cliente) > -1)
    arr_clientes_mostrados.push(id_cliente);
