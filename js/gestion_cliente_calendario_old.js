                              ...
                              for (var i = 0; i < data.data.length; i++) {
                                  ...
                                  if( obj_find === undefined ){//26082021
                                      ...
                                      if( idx_gestionado == -1 ){
                                          ...
                                          all_clientes.push({'codigo':$.trim(sc.codigo),'nombre_completo':$.trim(sc.nombre_completo),'posicion':posicion_futura} );//03092021
                                          posicion_futura++;
                                      }
                                  }
                              }
...
function llenar_llamadas() {
  ...
  $.post("../php/getClientsByUser_recordatorio.php", {
    ...
    for (var i = 0; i < cl.length - 1; i++) {
      ...
      $("#registrosD tbody").html(some + "<tr "+clase_color+" ><th scope=\"row\">" + sc[0] + "</th><td>" + sc[4] + "</td><td>" + sc[1] + "</td><td>" + sc[2] + "</td></tr>");
