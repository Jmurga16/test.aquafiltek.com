...
var distnacia_aumentar = 0.5;
var marker_referencia = null;
var nombre_aux = '';//25102021
var id_txt_nombre = '';//25102021
...
function gestionar_urgente(id_cliente) {
 ...
 console.log('urge aaa:'+urge+'--cliente_urgente_actual:'+cliente_urgente_actual);
  if(urge){
      console.log('no se asigna nuevo urgente sigue:'+cliente_urgente_actual);
  }
  else{
      console.log('anterior no era urgente :'+cliente_urgente_actual+'--nuevo:'+$.trim(id_cliente));
    cliente_urgente_actual = $.trim(id_cliente);
  }
  console.log('cliente_urgente_actual:'+cliente_urgente_actual);//05092021
  ...
  $.when($.post("../php/obtenerDatosCliente.php", {
    ...
    //20082021
    console.log('codigo_cli_anterior:'+codigo_seleccionado_aux+'-n ante:'+nombre_aux);//20082021 problema cli sel
        if( $("#cliente_selc_pargestion").val().trim() != '' ){
            console.log('había anterior:'+$("#cliente_selc_pargestion").val()+'---');//05092021
            codigo_seleccionado_aux = $("#cliente_selc_pargestion").val();
            console.log(' anterior '+codigo_seleccionado_aux);
            $(id_txt_nombre).text(nombre_aux);//25102021
        }
    var w = mensaje.split("|");
    ...
    $("#tabla_clienteU_"+id_cliente+" tbody").html("<tr><th scope=\"row\" class='td_nombre_urgente'>" + w[1] + "</th><th>" + w[2] + "</th><td>" + w[3] + "</th><td>" + w[11] + "</td></tr>");//05092021
                    ...
                    $.post("../php/Cliente_acepto.php", {
                      ...
                      comentario: comentario
                        ...
                        if(ultimoMarker != null){
                          ...
                          placeMarker(ultimoMarker);//22092021
                        } 
    ...
    */
    $("body").on("click",'.modalMinimize', function(){
        ...
        if ( $($modal).hasClass("min") ){ 
            ...
            //20082021 problema cli sel
            if( $('#cliente_selc_pargestion').val().trim() != '' ){
                console.log('val ante:'+$('#cliente_selc_pargestion').val()+'--nombre'+nombre_cliente_actual+'-n act:'+nombre_cliente_actual+'---'+id_txt_nombre+'----'+$(id_txt_nombre).text());//25102021
                
                console.log('val ante:'+$('#cliente_selc_pargestion').val());
                codigo_seleccionado_aux = $('#cliente_selc_pargestion').val();
                nombre_aux = $(id_txt_nombre).text();
                $('#cliente_selc_pargestion').val(arr_str_id[1]);
                console.log('nuevo sel:'+$('#cliente_selc_pargestion').val());
                //27082021
                let idxurg = arr_id_urgente.indexOf(arr_str_id[1]);
...
function guardar_otras_gestiones(id_modal, id_txt_gestion ,hora, fecha,comentario, tipo_gestion){
    ...
    $("#btn_importante").click(function() {
     ...
     /*18102021$("#btn_importante").click(function() {
        console.log(nombre_cliente_actual);
    ...
    function initMap() {
        map = new google.maps.Map(document.getElementById('map'), {
          ...
          google.maps.event.addListener(map, 'click', function(event) {
              console.log('ultimo marker');
              console.log(ultimoMarker);
              ultimoMarker = event.latLng;//22092021;
    ...
    $(document).on('click','.btn_aceptoU',function(){
        ...
        console.log('pla aceptó nombre_cliente_actual:'+nombre_cliente_actual+' n:'+nombre_cliente_actual);//05092021
        console.log('cliente_urgente_actual:'+cliente_urgente_actual);//05092021
        miminizarModals();
        //05092021
      ...
      //$(".fechapicker").datepicker("open");
      cliente_actual = cliente_urgente_actual;
      console.log('new cliente_actual:'+cliente_actual);
      $("#cliente_selc_pargestion").val(cliente_urgente_actual)
    ...
    function closeActualModal(){
        ...
        if( $('#ModalA').hasClass('show') ){
           ...
           id_txt_nombre = "#idclCobros";//25102021
            ...
            id_txt_nombre = "#idCliente";//25102021
            modal_abierto ="#ModalR";
            $('#ModalR').modal('hide');
            
        }else if( $('#ModalRE').hasClass('show') ){
             id_txt_nombre = "#idclR";//25102021
