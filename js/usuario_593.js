    ...
    $.when(
      ...
      function procesar(data){
        ...
        if (data.principal.estado !== "Por gestionar") {
            ...
            "<a href='tel:+593"+data.principal.telefono+"'>"+data.principal.telefono+"</a>" + "<input type='text' id='telefono_casa' style='width: 100%;'/><br>"+
            data.principal.tipo_persona_tel_cliente + "<br>"+
            data.principal.obser_tel_cliente +"</td><td>" + 
            "<a href='tel:+593"+data.principal.telefono_oficina+"'>"+data.principal.telefono_oficina+"</a>" + "<input type='text'id='Telefono_Trabajo' style='width: 100%;'/><br>"+
            data.principal.tipo_persona_tel_of + "<br>"+      
            data.principal.obser_tel_of +"</td><td>" + 
            "<a href='tel:+593"+data.principal.celular1+"'>"+data.principal.celular1+"</a>" + "<input type='text' id='Celular_1' style='width: 100%;'/><br>"+
            data.principal.tipo_persona_cel1 + "<br>"+
            data.principal.obser_cel1 +"</td><td>" + 
            "<a href='tel:+593"+data.principal.celular2+"'>"+data.principal.celular2+"</a>" + "<input type='text' id='Celular_2' style='width: 100%;'/><br>"+
            ...
            data.principal.Datos_factura +  "</th><td>" + 
            data.principal.direccion  + "</td><td>" + 
            "<a href='tel:+593"+data.principal.telefono+"'>"+data.principal.telefono+"</a>" + "<br>"+
            data.principal.tipo_persona_tel_cliente + "<br>"+
            data.principal.obser_tel_cliente +"</td><td>" + 
            "<a href='tel:+593"+data.principal.telefono_oficina+"'>"+data.principal.telefono_oficina+"</a>" + "<br>"+
            data.principal.tipo_persona_tel_of + "<br>"+      
            data.principal.obser_tel_of +"</td><td>" + 
             "<a href='tel:+593"+data.principal.celular1+"'>"+data.principal.celular1+"</a>" +  "<br>"+
            data.principal.tipo_persona_cel1 + "<br>"+
            data.principal.obser_cel1 +"</td><td>" + 
             "<a href='tel:+593"+data.principal.celular2+"'>"+data.principal.celular2+"</a>"  + "<br>"+
            data.principal.tipo_persona_cel2 + "<br>"+
            data.principal.obser_cel2 +"</td><td>" + 
            data.principal.numero_libre+"</td><td>" + 
            data.principal.correo  + "</td><td>" + 
...
function actualizarCookie(search){
    console.log('ac cookie '+search+'---selected:'+$("#cliente_seleccionado").html());
...
function search_client(idbotonbuscar){
    console.log('llama a search_client');
    $("#"+idbotonbuscar).addClass('disabled');
      ...
      if (cl==="0x000" || cl=="") {
       ...
       setTimeout(() => {
          actualizarCookie(1);
          //26082021
          console.log('después actualizar cookie');
          $("#cliente_seleccionado").html("0x000");
...
function search_client_enter(idbotonbuscar,cl){
    console.log('bt:'+idbotonbuscar+' cl:'+cl);
      ...
      primer_enter = false;
        /*26082021 $("#cliente_seleccionado").html("0x000");
        $('#cliente_gestionar').val('').trigger('change');
        $('#input_BCC').val('').trigger('change');
        $('#input_BCCC').val('').trigger('change');
        $('#input_buscar_factura').val('').trigger('change');
