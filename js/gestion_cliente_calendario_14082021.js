...
switch (num) {
  ...
  case 3:
    {
      $("#ContainerVM").html("https://www.alcanzatussuenos.com/wp-content/uploads/2017/03/Intentalo-una-y-otra-vez-hasta-que-tus-miedos-te-tengan-miedo-1024x1024.jpg\" class=\"img_motivacional\"> ");
      break;
    }
  case 4:
    {
            ...
            if(!data.error){
                if( data.filas.length > 0 ){
                    ...
                    for( let i = 0 ; i < data.filas.length ; i++ ){
                        ...
                        filas += '<td>'+fila.nombre_completo+'</td>';
                        filas += '<td>'+fila.datos_factura+'</td>';
    ...
    $("#GuardarInspeccion").click(function() {
        ...
        $("#GuardarInspeccion").addClass('disabled');
          ...
          if ($("#fechaAceptoInspeccion").val() == "") {
            ...
            let response_data = guardar_tiempo_otros( GESTION_INSPECCION , $("#cliente_selc_pargestion").val());//fredd
    ...
    $("#GuardarCobros").click(function() {
        ...
        $("#GuardarCobros").addClass('disabled');
          ...
          if ($("#fechaAceptoCobros").val() == "") {
            ...
            let response_data = guardar_tiempo_otros( GESTION_COBROS , $("#cliente_selc_pargestion").val());//fredd
            
            console.log('response_data  :');
            console.log(response_data);
            if(response_data){
               guardar_otras_gestiones('ModalCobros','Cobros',hora,fecha,comentario,GESTION_COBROS);
